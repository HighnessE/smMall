...
<template>
  <section class="mergood-detailcontent">
    ...
    <div class="detailcontent">
      ...
      <!--</div>-->
      <button class="goodbuynow" @click="openHandlepanel" v-if="ifgoodbuynow">配送支付</button>
      <section class="handlepanel" @touchmove.stop.prevent @click="closeHandlepanel" v-else>
        <div class="suspendwrap" @click.stop>
          ...
          <button class="submitorder" @click="clickRouter">提交订单</button>
        </div>
      </section>
    </div>
  </section>
...
<script type="text/ecmascript-6">
  ...
  import oneMerchantgood from 'components/module/one-merchantgood'
  export default {
    components: {
      myHeader,
      oneMerchantgood,
    ...
    methods: {
      ...
      clickRouter () {
        ...
        this.$router.push({
          ...
          query: {gid: ogid, number: this.countnum}
        })
      },
      increase () {
        this.countnum += 1
