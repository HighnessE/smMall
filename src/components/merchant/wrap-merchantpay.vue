    ...
    methods: {
      ...
      clickPayway (msg) {
        ...
        if (msg === 1) {
          ...
          // 使用微信支付
          this.$store.state.merchantpay.orderinfo.pay = 1
          this.$store.state.merchantpay.orderinfo.status = 1
          this.$store.state.merchantpay.orderinfo.total = this.mercalculate
      ...
      confirmbtn () {
        let that = this
        this.$store.state.merchantpay.orderinfo.pay = 2
        this.$store.state.merchantpay.orderinfo.status = 1
        this.$store.state.merchantpay.orderinfo.total = this.mercalculate
...
//            location.href = res.url
            ...
            that.$store.state.confirmmoney = that.orderinfo.total
            that.$store.state.confirmmerchant = that.gooditems.bname
