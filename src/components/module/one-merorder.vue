  ...
  <section>
    ...
    <div class="singleorder">
      <router-link class="merchantinfo"
                   ...
                   tag="h4">
        {{ merordersitems.bname }}
        <img :src=rightarrow alt="">
      </router-link>
      <router-link class="topblock"
                   tag="div"
                   :to="{ path: '/center/merorders/detail', query: { oid: merordersitems.id } }">
        <div class="topimg">
          <img :src=merordersitems.t_mainpic alt="">
        </div>
        <div class="topright">
          <div class="topfirstline">
            <div class="ordername">{{ merordersitems.t_name }}</div>
            <div>￥ {{ merordersitems.t_price }}</div>
          </div>
          <div class="topsecondline">
            <!--<span>颜色：{{ merordersitems.color }} 尺码: {{ merordersitems.size }}</span>-->
            <span>x {{ merordersitems.t_number }}</span>
          </div>
        </div>
      </router-link>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      viewCallback () {
        this.ifverify = true
        this.verifyinfo = this.merordersitems.refund
      },
      closeVerify () {
        this.ifverify = false
      }
