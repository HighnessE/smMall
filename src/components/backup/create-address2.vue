  ...
  export default {
    ...
    methods: {
      ...
      formcheck () {
        ...
        let onumber = this.$route.query.onumber
        if (!submitaddr.name) {
        ...
        this.$http({
          ...
          that.$router.push({path: '/merchant/details/goods/confirm', query: {gid: ogid, number: onumber}})
        })
      },
      GetDataFromBackend () {
        let that = this
    ...
    beforeRouteLeave (to, from, next) {
      if (to.path === '/merchant/details/goods/confirm') {
